...
{
   //class which represent message that is publish by Publisher and capture by interested Subscriber
    ...
    //Class provide event DataPublisher , subscriber attach themselves to this event to listen the message
    public class Publisher<T> : IPublisher<T>
    {
        ...
        //PublishData publisher class method that publish data to Subscribers
